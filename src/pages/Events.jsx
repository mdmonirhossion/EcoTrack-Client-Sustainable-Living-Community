  ...
  useEffect(() => {
    api.get('/api/events')
      .then((res) => {
        ...
        const normalized = Array.isArray(rawData) ? rawData : (rawData?.events || rawData?.data || []);
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {loading
            ...
            : events.map((event, i) => {
              ...
              const maxPart = event.maxParticipants || 1;
              const percentage = Math.round((event.currentParticipants / maxPart) * 100);
