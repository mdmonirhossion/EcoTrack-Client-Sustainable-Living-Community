  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-72 md:h-96">
        ...
        {/* Edit + Delete — login থাকলে সবাই দেখবে */}
        {user && (
            ...
            <button
              onClick={() => {
                setEditData({
                  ...challenge,
                  startDate:
                    challenge.startDate?.split("T")[0] || challenge.startDate,
                  endDate:
                    challenge.endDate?.split("T")[0] || challenge.endDate,
                });
                setShowEditModal(true);
              }}
              className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-white transition bg-blue-500 shadow-lg hover:bg-blue-600 rounded-xl"
            >
              <FaEdit /> Edit
            </button>
            <button
              onClick={() => setShowDeleteModal(true)}
              className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-white transition bg-red-500 shadow-lg hover:bg-red-600 rounded-xl"
            >
              <FaTrash /> Delete
            </button>
          </div>
          ...
          <div className="w-full max-w-sm p-8 bg-white shadow-2xl rounded-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={deleting}
                className="flex items-center justify-center flex-1 gap-2 py-3 text-sm font-semibold text-white transition bg-red-500 hover:bg-red-600 rounded-xl disabled:opacity-60"
              >
                {deleting ? (
            ...
            <form onSubmit={handleEdit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditData({ ...editData, impactMetric: e.target.value })
                  }
                  className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400"
                />
              </div>
